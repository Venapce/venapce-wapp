...
export const ICONS = {
  ...
  // ---- Pipeline: severity / status / disposition glyphs -----------------------
  alertOctagon:
    '<path d="M8.2 3h7.6L21 8.2v7.6L15.8 21H8.2L3 15.8V8.2Z"/><path d="M12 8v4.5M12 16h.01"/>',
  ...
  checkCircle: '<circle cx="12" cy="12" r="9"/><path d="m8 12.5 2.7 2.7L16.5 9.5"/>',
  xCircle: '<circle cx="12" cy="12" r="9"/><path d="m9 9 6 6M15 9l-6 6"/>',
  minusCircle: '<circle cx="12" cy="12" r="9"/><path d="M8 12h8"/>',
  circleDot: '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="2.6" fill="currentColor" stroke="none"/>',
  ...
  gauge: '<path d="M4.5 16.5a8.5 8.5 0 1 1 15 0"/><path d="m12 15 4-5"/><circle cx="12" cy="15" r="1.4" fill="currentColor" stroke="none"/>',
  tag: '<path d="M3.5 12.5v-8a1 1 0 0 1 1-1h8l8 8-8 8Z"/><circle cx="8" cy="8" r="1.3" fill="currentColor" stroke="none"/>',
  workflow: '<rect x="3" y="3" width="6" height="6" rx="1.5"/><rect x="15" y="15" width="6" height="6" rx="1.5"/><path d="M9 6h4a2 2 0 0 1 2 2v7"/>',
  fingerprint:
    '<path d="M6.5 8.5A6.5 6.5 0 0 1 18.5 12v2"/><path d="M4.5 12a7.5 7.5 0 0 1 1-3.7"/><path d="M9 12a3 3 0 0 1 6 0v4"/><path d="M12 12v8"/><path d="M15 18.5V17"/><path d="M6.5 14.5V12"/>',
